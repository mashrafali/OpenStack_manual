...
MNGsubnetCIDR="172.17.14.0/24"    #MANGMENT SUBNET
...
ProvNetStart=192.168.65.150       #Provider Network Allocation Start
ProvNetEnd=192.168.65.180         #Provider Network Allocation End
ProvNetGW=192.168.65.1            #Provider Network GW
ProvNetCIDR=192.168.65.0/24       #Provider Network CIDR
##################### SERVICES SELECTION
...
export PS1=($cloudaka-admin)$PS1" > /etc/keystone/admin-openrc.sh
echo "export OS_PROJECT_DOMAIN_NAME=Default
export OS_USER_DOMAIN_NAME=Default
...
cp /etc/keystone/admin-openrc.sh /root/stackrc
echo "[OK]"
echo
echo
...
sleep 1
cp /etc/openstack-dashboard/local_settings.py /root/local_settings.py.DEFAULT
...
swift-ring-builder account.builder add --region 1 --zone 1 --ip object1 --port 6202 --device sdb --weight 100
swift-ring-builder account.builder add --region 1 --zone 1 --ip object1 --port 6202 --device sdc --weight 100
swift-ring-builder account.builder
swift-ring-builder account.builder rebalance
sleep 2
swift-ring-builder container.builder create 10 1 1
swift-ring-builder container.builder add --region 1 --zone 1 --ip object1 --port 6201 --device sdb --weight 100
swift-ring-builder container.builder add --region 1 --zone 1 --ip object1 --port 6201 --device sdc --weight 100
...
swift-ring-builder object.builder add --region 1 --zone 1 --ip object1 --port 6200 --device sdc --weight 100
swift-ring-builder object.builder
swift-ring-builder object.builder rebalance
sleep 2
clear
echo ; echo ; echo " >>> I Need the SSH Root Password for Object Node : object1"
echo "-> Hit enter when you are ready"
read
echo ; echo
...
neutron subnet-create --name selfservice --dns-nameserver 8.8.8.8 --gateway 10.21.31.1 selfservice 10.21.31.0/24
